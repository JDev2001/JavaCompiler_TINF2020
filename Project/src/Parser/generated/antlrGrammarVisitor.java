...
public interface antlrGrammarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link antlrGrammarParser#varDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVarDeclaration(antlrGrammarParser.VarDeclarationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link antlrGrammarParser#assignOperator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssignOperator(antlrGrammarParser.AssignOperatorContext ctx);
	/**
